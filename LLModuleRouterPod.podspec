...
Pod::Spec.new do |spec|
  ...
  # 开源库地址
  spec.homepage     = "https://github.com/LLExtend/LLModuleRouterPod.git"
  ...
  # 开源库Github路径
  spec.source       = { :git => "https://github.com/LLExtend/LLModuleRouterPod.git", :tag => "#{spec.version}" }
